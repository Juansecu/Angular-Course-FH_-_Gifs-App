// To parse this data:
//
//   import { Convert, GIFResponse } from "./file";
//
//   const gIFResponse = Convert.toGIFResponse(json);
//
...
export class Convert {
  public static toGIFResponse(json: string): GifResponse {
    return cast(JSON.parse(json), r('GIFResponse'));
  }

  public static gIFResponseToJson(value: GifResponse): string {
    return JSON.stringify(uncast(value, r('GIFResponse')), null, 2);
  }
}
